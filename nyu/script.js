...
let imgDescriptions = ["Diwaniya setup", "The Tabel", "The Manjur", "Members of Boom.Diwan", "Tightening the Merwas", "Playing the Yahalas","Hamad playing the Tabel",  "Incorporating dance", "Clapping along the rhythm", "Playing with Boom.Diwan", "The Hawan and Tabel", "Pulling the anchor", "Marawees and Yahalas", "Tanbura dance", "Final Recital", "Final Recital closer", "Traditional dance", "Marawees with guests", "Daby playing the piano", "Practicing", "Setting up the Manjur", "Tabel, Hawan, Merwas, Yahala", "Tightening the tabel", "Incorporating electric guitar"];
let vidDescriptions = ["Learning how to tighten the Merwas","Boom.Diwan guests tightening the Tabel","Closeup of Boom.Diwan guests tightening the Tabel","Abdullah teaching us how to use the Manjur","Closeup on the musical instruments - Merwas in the front, Tabel on the left, Yahala on the right", "Practicing Hasawi with Professor Ghazi using Merwas, Yahala and Tabel", "Practicing Hasawi with Hamad Alsaeed and Hamad bin Hussein using Merwas, Yahala and Tabel","Practicing Hasawi before the Boom.Diwan’s Technique Workshop","Closeup video of performing Hasawi in the final recital","Boom.Diwan Guests teaching Mukhalif", "Practicing Mukhalif while incorporating the Guitar and Piano","Closeup video of practicing Mukhalif while incorporating the Guitar and Piano","Doing the ornamentation on Mukhalif using Tabel","Practicing Mukhalif for Boom.Diwan’s Technique Workshop while incorporating the Guitar and Piano","Closeup video of practicing Mukhalif for Boom.Diwan’s Technique Workshop while incorporating the Guitar and Piano","Mark practicing using Manjur with a closeup of the rhythm on Tabel","Mark practicing Manjur before our performance in the final recital","Learning and Practicing Traditional dance before the final recital","Traditional dance performance in the final recital","Boom.Diwan’s guests perform a special dance in the final recital","Performing Mukhalif in the final recital with rhythmic clapping","Singing and performing Mukhalif in the final recital","Closeup video of singing and performing Mukhalif in the final recital"]
